...
class StandardEncoderLayer(nn.Module):
    """Standard encoder layer WITHOUT hybrid architecture (no cross-attention)"""
    ...
    def forward(self, x, cross=None, x_mask=None, cross_mask=None, tau=None, delta=None):
        ...
        # NO cross-attention (removed hybrid functionality)
...
class Model(nn.Module):
    ...
    Ablation study: Removes cross-attention (hybrid functionality) while keeping other components
    """
    ...
    def __init__(self, configs, patch_len=16, stride=8):
        ...
        # Exogenous embedding (not used without cross-attention)
        ...
        # Standard encoder (NO cross-attention/hybrid functionality)
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        # NO exogenous embedding processing (no cross-attention)
        
        # Standard encoder processing (NO cross-attention)
        for layer in self.encoder:
            enc_out = layer(enc_out)  # No cross parameter
