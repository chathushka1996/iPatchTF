...
class BasicPatchEmbedding(nn.Module):
    """Basic patch embedding WITHOUT enhancements"""
...
class EnhancedHybridEncoderLayer(nn.Module):
    """Enhanced encoder layer with frequency attention and adaptive normalization"""
...
class Model(nn.Module):
    ...
    Ablation study: Removes enhanced patch embedding while keeping other components
    """
    ...
    def __init__(self, configs, patch_len=16, stride=8):
        ...
        # Enhanced encoder (keeps frequency attention and adaptive normalization)
