...
class StandardHybridEncoderLayer(nn.Module):
    """Standard encoder layer WITHOUT frequency-enhanced attention"""
    def __init__(self, self_attention, cross_attention, d_model, d_ff=None,
                 dropout=0.1, activation="gelu"):
        super(StandardHybridEncoderLayer, self).__init__()
    ...
    def forward(self, x, cross=None, x_mask=None, cross_mask=None, tau=None, delta=None):
        # Standard self-attention (NO frequency enhancement)
...
class Model(nn.Module):
    ...
    Ablation study: Removes frequency-enhanced attention while keeping other components
    """
    ...
    def __init__(self, configs, patch_len=16, stride=8):
        ...
        # Standard encoder (NO frequency enhancement)
        self.encoder = nn.ModuleList([
            StandardHybridEncoderLayer(
                AttentionLayer(
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        # Standard encoder processing (NO frequency enhancement)
