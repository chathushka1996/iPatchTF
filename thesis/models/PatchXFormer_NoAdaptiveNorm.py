...
class EnhancedPatchEmbedding(nn.Module):
    ...
    def forward(self, x):
        ...
        # Apply standard normalization and dropout (NO adaptive normalization)
...
class EnhancedHybridEncoderLayer(nn.Module):
    """Enhanced encoder layer WITHOUT adaptive normalization"""
...
class Model(nn.Module):
    ...
    Ablation study: Removes adaptive normalization while keeping other components
    """
    ...
    def __init__(self, configs, patch_len=16, stride=8):
        ...
        # Enhanced patch embedding (NO adaptive normalization)
        padding = stride
        ...
        # Enhanced encoder (NO adaptive normalization)
